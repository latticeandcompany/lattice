...
See [Caching](/lattice/docs/caching) for what a hit is worth and
[Output and logging](/lattice/docs/output-modes) for where the summary prints.
...
lines and [Troubleshooting](/lattice/docs/troubleshooting) for reading a miss.
