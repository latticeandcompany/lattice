...
- Any public interaction representing Lattice
...
Advocacy for or against a specific tool is on-topic only when it bears on:

- Detection correctness (what evidence identifies a tool)
- Version resolution or provisioning behavior
- Compatibility, portability, or platform support
- Maintenance cost of a driver
...
- Email <rpmullin17@gmail.com>, or
- Contact Ryan directly on GitHub
